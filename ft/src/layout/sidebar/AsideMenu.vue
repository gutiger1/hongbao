<template>
    <el-menu class="el-menu-vertical-demo" background-color="$menuBg" text-color="#fff" active-text-color="#ffd04b"
        unique-opened router :collapse="sidebarStore.isCollapsed" collapse-transition :default-active="$route.path"
        v-if="!expiredDialogVisible">
        ...
        <el-sub-menu index="2">
            ...
            <el-menu-item index="/event-link">活动管理</el-menu-item>
        ...
        <el-sub-menu index="4">
            ...
            <el-menu-item index="/inviteactivity">邀请活动</el-menu-item>
        </el-sub-menu>
    </el-menu>
</template>
...
//     background-color: #2b2f3a; // 主菜单背景色
// }
